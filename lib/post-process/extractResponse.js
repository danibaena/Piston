'use strict';
/**
 * [extractResponse description]
 * @param  {object, array} response    [A parsed JSON response from an API]
 * @param  {string, array, object} specExtract [extract field specified in the API spec]
 * @return {string, array, object}             [The formatted fields from the response]
 */
